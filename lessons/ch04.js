...
(function () {
  ...
  PY_COURSE.addChapter({
    ...
    summary: '더하기 · 빼기 같은 산술 연산자부터 비교(관계) · 논리 · 비트 연산자까지 파이썬의 연산자를 모두 배우고, 연산자 우선순위와 형 변환을 익힙니다. 배운 연산자로 동전 교환 프로그램과 화면 안을 마음대로 돌아다니는 거북이 프로그램을 만듭니다.',
    goals: [
    ...
    sections: [
      /* ═════════════════════════ 4-1 ═════════════════════════ */
      {
        ...
        flow: [['도입: 만들 프로그램 미리 보기', 7], ['연산자 · 산술 연산자 7가지', 15], ['// 와 % · 세미콜론과 콤마', 10], ['산술 연산자 우선순위', 10], ['퀴즈 · 실습 · 정리', 8]],
        content: [
  ...
  <text x="60" y="160" font-size="16" fill="var(--muted)">아래쪽(트리의 잎)부터 계산</text>
        ...
        practice: [
          { title: '실습 4-1. 두 수의 산술 연산', level: 1,
            ...
            stdin: '17\n5\n',
            expect: '첫 번째 수 : 17\n두 번째 수 : 5\n17 + 5 = 22\n17 - 5 = 12\n17 * 5 = 85\n17 / 5 = 3.4\n17 // 5 = 3\n17 % 5 = 2\n17 ** 5 = 1419857' },
          { title: '실습 4-2. 초를 시 · 분 · 초로 바꾸기', level: 2,
        ...
        quiz: [
          ...
          { q: '<code>a = 5; b = 3</code> 과 결과가 <b>다른</b> 것은?', options: ['<code>a, b = 5, 3</code>', '두 줄로 <code>a = 5</code> 와 <code>b = 3</code>', '<code>a = b = 5</code> 다음 줄에 <code>b = 3</code>', '<code>a, b = 3, 5</code>'], answer: 3,
            explain: '<code>a, b = 3, 5</code> 는 a 에 3, b 에 5 가 들어가 순서가 반대입니다. 세 번째는 a, b 모두 5 가 된 뒤 b 만 3 으로 바뀌므로 결과가 같습니다.' },
  ...
  <text x="40" y="205" font-size="28" fill="var(--accent2)">17 % 5  → 2  (나머지)</text>
          ...
          { layout: 'practice', title: '실습 4-2. 초를 시 · 분 · 초로', desc: '초를 입력받아 <b>몇 시간 몇 분 몇 초</b>인지 출력하세요. (3725 → 1시간 2분 5초)',
            starter: 'sec = int(input("초 : "))\n\n# TODO: 시간, 분, 초 구하기\n',
            solution: 'sec = int(input("초 : "))\n\nhour = sec // 3600\nsec = sec % 3600\nminute = sec // 60\nsec = sec % 60\n\nprint("%d시간 %d분 %d초" % (hour, minute, sec))\n', stdin: '3725\n',
          ...
          { layout: 'summary', title: '1교시 정리', bullets: [
            ...
            '산술 연산자: <code>+ - * / // % **</code>',
            '<code>/</code> 는 항상 실수, <code>//</code> 몫, <code>%</code> 나머지',
            '우선순위: 괄호 → 곱셈 · 나눗셈 → 덧셈 · 뺄셈 (같으면 왼쪽부터)',
      ...
      /* ═════════════════════════ 4-2 ═════════════════════════ */
      {
        ...
        flow: [['복습: // 와 %', 3], ['문자열 ↔ 숫자 변환', 12], ['대입 연산자', 10], ['[프로그램 1] 동전 교환 완성', 17], ['SELF STUDY · 정리', 8]],
        content: [
  ...
  <text x="325" y="212" text-anchor="middle" font-size="18" fill="var(--accent2)" font-family="monospace">float()</text>
          ...
          { type: 'callout', kind: 'more', title: '📘 더 알아보기: 파이썬에는 ++ 가 없다', html: 'C · 자바에서는 1 증가를 <code>a++</code> 로 쓰지만 파이썬에는 <b>증감 연산자가 없습니다</b>. <code>a++</code> 는 문법 오류(SyntaxError)이고, <code>++a</code> 는 오류는 아니지만 <code>+(+a)</code> 로 해석되어 값이 바뀌지 않습니다. 1 증가는 <code>a += 1</code> 로 씁니다.' },
        ...
        practice: [
          ...
          { title: '실습 4-3. 문자열 연결과 숫자 덧셈', level: 1,
        ...
        quiz: [
          ...
          { q: '<code>print(int("100") + 1)</code> 의 결과는?', options: ['1001', '101', '100.0', '오류'], answer: 1,
            explain: '<code>int("100")</code> 은 정수 100 이므로 100 + 1 = 101 입니다.' },
  ...
  <g font-size="24" fill="var(--fg)">
    ...
    <text x="30" y="215">27 // 10 = <tspan fill="var(--accent)" font-weight="bold">2개</tspan></text><text x="400" y="215">27 % 10 = <tspan fill="var(--accent2)" font-weight="bold">7</tspan> (잔돈)</text>
          ...
          { layout: 'summary', title: '2교시 정리', bullets: [
            ...
            '문자열 <code>+</code> 는 연결, 숫자 <code>+</code> 는 덧셈',
            '대입 연산자 <code>+= -= *= /= //= %= **=</code>',
      ...
      /* ═════════════════════════ 4-3 ═════════════════════════ */
      {
        ...
        flow: [['도입: 크다 · 작다 · 같다', 3], ['관계 연산자 · = 와 ==', 12], ['논리 연산자 · 참/거짓 값', 13], ['[프로그램 2] 거북이 완성', 15], ['퀴즈 · 정리', 7]],
        content: [
          { type: 'h', text: '관계 연산자' },
  ...
  <text x="530" y="228" text-anchor="middle" font-size="14" fill="var(--muted)">swidth = sheight = 300</text>
        ...
        practice: [
          { title: '실습 4-4. 윤년 판별식', level: 2,
            ...
            stdin: '1900\n',
            expect: '연도 : 1900\n1900 년은 윤년? False' },
          { title: '실습 4-5. 거북이 프로그램 바꿔 보기', level: 2,
        ...
        quiz: [
          ...
          { q: '두 값이 같은지 비교하는 연산자는?', options: ['<code>=</code>', '<code>==</code>', '<code>=&gt;</code>', '<code>!=</code>'], answer: 1,
            explain: '<code>=</code> 는 대입, <code>==</code> 가 같은지 비교, <code>!=</code> 는 다른지 비교입니다.' },
  ...
  <g font-family="monospace" font-size="20">
    ...
    <text x="370" y="210" fill="var(--accent2)">-150 &lt;= curY &lt;= 150</text>
          ...
          { layout: 'practice', title: '실습 4-4. 윤년 판별식', desc: '연도를 입력받아 윤년이면 True 를 출력하세요. (4 로 나누어떨어지고 100 으로는 안 나누어떨어지거나, 400 으로 나누어떨어지는 해)',
            starter: 'year = int(input("연도 : "))\n\n# TODO: 윤년 조건식\n',
            solution: 'year = int(input("연도 : "))\n\nleap = (year % 4 == 0 and year % 100 != 0) or (year % 400 == 0)\n\nprint(year, "년은 윤년?", leap)\n', stdin: '2024\n',
          ...
          { layout: 'summary', title: '3교시 정리', bullets: [
            ...
            '<code>=</code> 는 대입, <code>==</code> 는 비교',
            '논리 연산자 <code>and</code> · <code>or</code> · <code>not</code>',
            '0 은 False, 0 이 아닌 수는 True',
      ...
      /* ═════════════════════════ 4-4 ═════════════════════════ */
      {
        ...
        flow: [['2진수 복습 · 비트 연산자 종류', 7], ['& | ^', 13], ['마스크 · Code04-03', 10], ['~ 와 2의 보수', 5], ['시프트 · Code04-04', 10], ['정리', 5]],
        content: [
  ...
  <path d="M180 110 Q165 127 180 143" fill="none" stroke="var(--accent2)" stroke-width="2"/><text x="130" y="133" font-size="15" fill="var(--accent2)">+1</text>
        ...
        practice: [
          { title: '실습 4-6. 비트 연산으로 홀수 · 짝수 알아보기', level: 1,
            ...
            stdin: '13\n',
            expect: '정수 : 13\n13 의 2진수 : 0b1101\n13 & 1 = 1\n홀수인가? True' },
          { title: '실습 4-7. xor 로 대소문자 바꾸기', level: 2,
            ...
            stdin: 'g\n',
            expect: '영문자 한 글자 : g\ng → G' },
          { title: '실습 4-8. 시프트로 2의 거듭제곱 표 만들기', level: 1,
        ...
        slides: [
          ...
          { layout: 'practice', title: '실습 4-7. xor 로 대소문자 바꾸기', desc: '영문자 한 글자를 입력받아 <code>^ 32</code> 로 대문자 ↔ 소문자를 바꿔 출력하세요.',
            starter: 'ch = input("영문자 한 글자 : ")\n\n# TODO: ord(), ^, chr()\n',
            solution: 'ch = input("영문자 한 글자 : ")\n\ncode = ord(ch) ^ 32\nprint(ch, "→", chr(code))\n', stdin: 'g\n',
            notes: '<p>chr() 는 ord() 의 반대(코드값 → 문자)라는 것만 알려 주면 됩니다.</p>' },
      ...
      /* ═════════════════════════ 4-5 ═════════════════════════ */
      {
        ...
        flow: [['우선순위 표', 10], ['섞인 식 계산해 보기', 15], ['조건 표현식 · 흔한 실수', 8], ['종합 실습', 12], ['장 정리', 5]],
        content: [
  ...
  <text x="30" y="192" font-size="26" font-weight="bold" fill="var(--ok)">50</text>
        ...
        practice: [
          { title: '실습 4-9. 각 자리 숫자의 합', level: 2,
            ...
            stdin: '357\n',
            expect: '세 자리 정수 : 357\n백 : 3, 십 : 5, 일 : 7\n합계 : 15' },
          { title: '실습 4-10. 식의 계산 순서 예측하기', level: 1,
  ...
  <text x="30" y="170" font-size="30" fill="var(--accent2)" font-weight="bold">2 + 48</text><text x="380" y="170" font-size="22" fill="var(--accent2)">③ 50</text>
          ...
          { layout: 'practice', title: '실습 4-9. 각 자리 숫자의 합', desc: '세 자리 정수를 입력받아 백 · 십 · 일의 자리 숫자와 그 합을 출력하세요. (357 → 3, 5, 7, 합계 15)',
            starter: 'num = int(input("세 자리 정수 : "))\n\n# TODO: //, % 로 각 자리 구하기\n',
            solution: 'num = int(input("세 자리 정수 : "))\n\nd100 = num // 100\nd10 = num // 10 % 10\nd1 = num % 10\n\nprint("백 : %d, 십 : %d, 일 : %d" % (d100, d10, d1))\nprint("합계 :", d100 + d10 + d1)\n', stdin: '357\n',
            notes: '<p><code>num // 10 % 10</code> 이 왼쪽부터 계산된다는 점이 핵심입니다. 빨리 끝낸 학생은 네 자리 수로 확장해 보게 합니다.</p>' },
          { layout: 'summary', title: '4장 정리', bullets: [
            '산술 <code>+ - * / // % **</code> · 대입 <code>+= -= …</code>',
            '형 변환 <code>int() float() str()</code>',
            '관계 <code>== != &gt; &lt; &gt;= &lt;=</code> · 논리 <code>and or not</code>',
            '비트 <code>&amp; | ^ ~ &lt;&lt; &gt;&gt;</code>',
            '우선순위: 괄호 → ** → 산술 → 비트 → 비교 → not → and → or',
            '동전 교환(<code>// %</code>) · 거북이(<code>and</code>) 완성!'
          ], notes: '<p>다음 장(5장 조건문)에서는 오늘 배운 관계 · 논리 연산자로 if 문의 조건을 만듭니다. 연산자가 익숙하지 않은 학생은 4장 퀴즈를 다시 풀어 보게 합니다.</p>' }
        ]
      }
    ]
  });
